(defproject tilemapgl "0.1.0-SNAPSHOT"
  ...
  :cljsbuild {:builds
              [{:id "dev"
                ...
                ;; into your build
                :figwheel {:on-jsload "tilemapgl.core/on-js-reload"
                ...
                :compiler {:main tilemapgl.core
                           :asset-path "js/compiled/out"
                           :output-to "resources/public/js/compiled/tilemapgl.js"
